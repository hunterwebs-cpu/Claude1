...
6. **Track 19 — Theory 7 (place/device-capability tailoring): DONE.** (`research-output/part19-place-device-tailoring.md`). Bottom line: no case squarely ties monitoring scope to place-of-offense (genuine gap), but *United States v. Mike*, 632 F.3d 686 (10th Cir. 2011) (read in full), is directly parallel — held a monitoring condition vague for reaching devices the defendant didn't own, expressly including his employer's, rejecting the government's "cannot fairly be read that way" argument. Device-capability-based scoping (vs. "any connected device") is an established multi-circuit convention (Granger/Rath/Ullman/Fletcher/Phillips, [VERIFY]). Found a genuine textual hook: Bernecky's own condition opens with an "internet capable device" qualifier that the monitoring-authorization clause then drops — argument is to restore internal consistency, not import new law. "Forbid rather than monitor" third-party devices is unbriefed but a sound synthesis of this case's own least-restrictive-means/ultra vires/standing doctrine. Bonus reinforcing find: multi-circuit "simple possession" vs. "CP-plus" doctrine independently supports Track 18's image/text finding.
...
8. **Track 21 — counsel presence for real-time polygraph privilege calls: DONE.** (`research-output/part21-counsel-invocation-polygraph.md`). Bottom line: no federal case grants or was even asked to grant this — client's "unprecedented" instinct confirmed. One adverse state case found (*J.B. v. N.J. State Parole Bd.*, rejecting a counsel-presence claim on Miranda/custodial grounds) — must be confronted directly. Good news: Bernecky's actual "pure question of law" framing doesn't depend on custodial status, so it sidesteps that collision. New citable support: Guide to Judiciary Policy § 190.45's refer-to-the-court mechanism for uncertain officer-side invocations. Three real but non-controlling analogies (grand jury step-outside practice, *Herrera-Figueroa*'s PSR-interview supervisory-power holding, *Estelle v. Smith*). **Recommendation adopted: frame as a discretionary § 3583(d) request, not a Murphy-distinguishing constitutional claim; present relief as a descending menu (in-room → consultation breaks → advance written review).**
