# Exhibit B — Line-by-Line Client Objections

**Purpose:** a complete, line-by-line record of the client's objection (or
lack of one) to every line of the R.K.K.S. "Treatment Contract" (Exhibit
B), taken directly from the client going through the actual document text
pulled fresh from Google Drive. This is the source-of-truth catalogue for
the next full rewrite of Part II — built to satisfy the client's repeated
instruction (pending-edits items 5-6) that the motion address the whole
document, not a curated subset. Unlike `MOTION-v4-PENDING-EDITS.md`, this
file is not disposable per drafting round — it is the master record of
what the client actually objects to, line by line, and should persist
until Part II is rebuilt against it and confirmed complete.

Full document text as retrieved from Drive (file ID
`1hruHnKFsf6e45kYXEHsfl7nTjlPJN9fZ`) is the basis for every line quoted
below.
...
Treatment Contract (the 'Treatment Contract') with R.K.K.S. Mental Health
Counseling PLLC (the 'Practice')."
...
He signs it or goes to jail. That's his view — the "agreement" is not
really an agreement to anything; it is a condition of staying out of
custody.
...
**SPECIAL CONDITIONS ¶ 8:** "I will not purchase, possess, view, produce,
or use sexually stimulating material(s) of any kind as defined by my
treatment staff. I understand that I am required to notify treatment
staff within 24 hours of any incidents."

**Client's objection:** Huge problems with "material(s)" — is this porn?
